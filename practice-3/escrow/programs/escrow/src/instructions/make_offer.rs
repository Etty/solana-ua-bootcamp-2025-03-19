...
use anchor_spl::{
    ...
    token::{ApproveChecked, approve_checked},
...
pub fn approve_token_a_transfer(context: &Context<MakeOffer>, amount: u64) -> Result<()> {
    ...
    approve_checked(cpi_context, amount, context.accounts.token_mint_a.decimals)?;
    Ok(())
}
